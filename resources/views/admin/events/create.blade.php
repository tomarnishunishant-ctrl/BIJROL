...
<head>
    ...
    <title>@if(isset($event)) Edit @else New @endif Event | BIJROL Admin</title>
    ...
    <div class="admin-shell">
        ...
        <main class="admin-main">
            ...
            <div class="admin-card">
                <h1>@if(isset($event)) Edit @else New @endif Event</h1>

                <form method="POST" action="@if(isset($event)) {{ route('admin.events.update', $event) }} @else {{ route('admin.events.store') }} @endif" enctype="multipart/form-data">
                    @if(isset($event))
                        @method('PUT')
                    @endif
                    @csrf
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="is_featured" name="is_featured" value="1" @if(old('is_featured', $event->is_featured ?? false)) checked @endif>
                                <label class="form-check-label" for="is_featured">Featured event</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="is_published" name="is_published" value="1" @if(old('is_published', $event->is_published ?? false)) checked @endif>
