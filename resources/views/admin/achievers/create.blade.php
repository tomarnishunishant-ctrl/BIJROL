    ...
    <main class="admin-wrap">
        <div class="admin-card mb-3">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div>
                    <h1 class="fw-bold mb-1">Add Who's Who Profile</h1>
                    <p class="text-muted mb-0">Admin se naya achiever add karein.</p>
                </div>
        ...
        <form class="admin-card" method="POST" action="{{ route('admin.achievers.store') }}" enctype="multipart/form-data">
            @csrf
            @include('admin.achievers.form', ['achiever' => null])
        </form>
    </main>
</body>
</html>
